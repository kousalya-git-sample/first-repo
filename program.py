...
from wd.jobs.config.program_config import *
...
if _name_ == "_main_":
 ...
 dbh.create_external_table(dbutils, "silver_global", "program", "/global/confidential/externalemployee/wrkdnc/silver_layer/program/")